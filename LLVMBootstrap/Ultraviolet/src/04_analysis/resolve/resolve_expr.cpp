...
ResolveResult<T> MakeUnresolvedValueNameResult(const ScopeContext& ctx,
  ...
  if (name == "Option" || name == "Some" || name == "None") {
    err.diag_children.push_back(
        {core::SubDiagnosticKind::Help,
         "Ultraviolet uses union types (`T | ()`) instead of Option",
         {},
         {}});
  } else if (name == "Result" || name == "Ok" || name == "Err") {
    err.diag_children.push_back(
        {core::SubDiagnosticKind::Help,
         "Ultraviolet uses union types (`T | E`) instead of Result",
         {},
         {}});
  } else if (name == "Vec") {
    err.diag_children.push_back(
        {core::SubDiagnosticKind::Help,
         "Ultraviolet uses array types `[T; n]` or slice types `[T]`",
         {},
         {}});
  } else if (name == "Box" || name == "Rc" || name == "Arc") {
    err.diag_children.push_back(
        {core::SubDiagnosticKind::Help,
         "Ultraviolet uses `region` and `Ptr<T>` for heap allocation",
         {},
         {}});
  } else if (name == "String") {
    err.diag_children.push_back(
        {core::SubDiagnosticKind::Help,
         "Ultraviolet uses `string@View` and `string@Managed`",
         {},
         {}});
    ...
    err.diag_children.push_back(
        {core::SubDiagnosticKind::Help,
         "Ultraviolet does not have `" + std::string(name) +
