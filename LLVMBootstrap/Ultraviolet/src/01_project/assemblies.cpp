...
//   - ultraviolet-bootstrap/src/01_project/load_project.cpp (Assembly handling)
//   - ultraviolet-bootstrap/src/01_project/project_validate.cpp (ValidatedAssembly)
//
// =============================================================================
...
//
// Headers required:
//   - "uv/01_project/assemblies.h" (to be created)
//   - "uv/01_project/project.h" (Project, Assembly types)
//   - <string>
//   - <string_view>
//   - <vector>
//   - <optional>
