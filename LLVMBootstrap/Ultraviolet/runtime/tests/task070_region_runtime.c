...
static UVRegion make_region(void) {
  UVRegionOptions options;
  memset(&options, 0, sizeof(options));
  return ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3anew_x5fscoped(&options);
}

static int32_t* alloc_i32(const UVRegion* region, int32_t value) {
  int32_t* ptr = (int32_t*)ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3aalloc(
...
static int expect_active(const void* addr, int expected, const char* label) {
  const int actual =
      (int)ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3aaddr_x5fis_x5factive(addr);
  if (actual != expected) {
...
static int test_frame_reset_preserves_outer_and_expires_inner(void) {
  UVRegion region = make_region();
  int32_t* outer = alloc_i32(&region, 11);
  if (expect_nonnull(outer, "frame-reset outer alloc")) {
    return 1;
  }

  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3ascope_x5fenter(1001);
  const uint64_t mark =
      ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3amark(&region);
  int32_t* inner = alloc_i32(&region, 13);
  if (expect_nonnull(inner, "frame-reset inner alloc")) {
    return 1;
  }

  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3areset_x5fto(&region, mark);
  ...
  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3ascope_x5fexit(1001);
  ...
  UVRegion next_region = make_region();
  if (expect_active(inner, 0, "new region does not reactivate expired frame ptr")) {
    return 1;
  }

  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3afree_x5funchecked(&next_region);
  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3afree_x5funchecked(&region);
  return 0;
}
...
static int test_reset_unchecked_retags_all_live_entries(void) {
  ...
  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3ascope_x5fenter(2001);
  const uint64_t mark =
      ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3amark(&region);
  ...
  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3areset_x5funchecked(&region);
  ...
  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3ascope_x5fexit(2001);
  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3afree_x5funchecked(&region);
  return 0;
}
...
static int test_free_unchecked_pops_all_region_entries(void) {
  ...
  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3ascope_x5fenter(3001);
  (void)ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3amark(&region);
  ...
  if (ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3aalloc(
          &region, sizeof(int32_t), alignof(int32_t)) != NULL) {
    return report_failure("free-unchecked rejects further alloc");
  }

  ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3ascope_x5fexit(3001);
  return 0;
}
...
static int test_freeze_thaw_leave_runtime_sigma_unchanged(void) {
  ...
  UVRegion frozen = ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3afreeze(&region);
  int32_t* second = alloc_i32(&region, 41);
  if (expect_nonnull(second, "freeze preserves runtime state")) {
    return 1;
  }

  UVRegion thawed = ultraviolet_x3a_x3aruntime_x3a_x3aregion_x3a_x3athaw(&frozen);
