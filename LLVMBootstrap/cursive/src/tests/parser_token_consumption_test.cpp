...
using cursive::ast::ConsumeKind;
using cursive::ast::ConsumeKeyword;
using cursive::ast::ConsumeOperator;
using cursive::ast::ConsumePunct;
using cursive::ast::MakeParser;
using cursive::ast::Parser;
using cursive::core::Conformance;
using cursive::core::SourceFile;
using cursive::core::Span;
...
Token MakeToken(TokenKind kind, std::string lexeme, std::size_t offset) {
  ...
  token.span = Span{
      "parser_token_consumption.cursive",
      offset,
      end_offset,
      1,
      offset + 1,
...
SourceFile MakeSource() {
  SourceFile source;
  source.path = "parser_token_consumption.cursive";
