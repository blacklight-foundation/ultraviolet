...
//
// DEPENDENCIES:
//   - cursive/include/05_codegen/ir/ir_model.h (IRLoop, IRLoopKind::Conditional)
//   - cursive/include/05_codegen/lower/lower_expr.h (LowerCtx, LowerResult, MakeIR)
//   - cursive/include/05_codegen/lower/lower_stmt.h (LowerBlock)
//
// =============================================================================
