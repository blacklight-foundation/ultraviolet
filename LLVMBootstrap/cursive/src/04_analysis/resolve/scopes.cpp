...
//
// SPEC REFERENCE:
//   CursiveSpecification.md §5.1.1 "Scope Context and Identifiers" (Lines 6659-6717)
//   CursiveSpecification.md §3.1.6 "IdKey, IdEq, PathKey, PathEq"
//
// SOURCE FILE:
...
const std::vector<std::string_view>& UniverseProtectedNames() {
  ...
  static const std::vector<std::string_view> names = {
      ...
      "ExecutionDomain", "Reactor", "Network", "Time", "MonotonicTime",
      "WallTime", "Duration", "MonotonicInstant", "UtcInstant", "TimeError",
...
const std::vector<std::string_view>& SpecialTypeNames() {
  ...
  static const std::vector<std::string_view> names = {
      ...
      "Network", "Time", "MonotonicTime", "WallTime", "Duration",
      "MonotonicInstant", "UtcInstant", "TimeError"};
  return names;
}
