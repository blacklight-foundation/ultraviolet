...
//
// SPEC REFERENCE:
//   - CursiveSpecification.md, Section 10.1 "Binding Operators" (lines 22110-22200)
//   - CursiveSpecification.md, Section 10.2 "Binding States" (lines 22210-22300)
//   - CursiveSpecification.md, Section 10.3 "Move Semantics" (lines 22310-22400)
//   - CursiveSpecification.md, Section 10.4 "Permission System" (lines 22410-22500)
//   - CursiveSpecification.md, Section 8.9 "E-OWN Errors" (lines 21800-21900)
//
// SOURCE FILE:
//   - cursive-bootstrap/src/03_analysis/memory/borrow_bind.cpp
//
...
void LogBorrowBindPerfSummary() {
  ...
  std::fprintf(stderr,
               "[cursive] sema perf=borrow-bind body_calls=%llu "
