 ...
 *
 * SPEC REFERENCE:
 *   - CursiveSpecification.md, Section 5.6 "String and Bytes Types" (lines 13160-13300)
 *   - CursiveSpecification.md, Section 5.6.1 "String States" (lines 13170-13220)
 *   - CursiveSpecification.md, Section 5.6.2 "Bytes States" (lines 13230-13280)
 *   - CursiveSpecification.md, Section 5.6.3 "String/Bytes Methods" (lines 13290-13400)
 *
 * SOURCE FILE:
