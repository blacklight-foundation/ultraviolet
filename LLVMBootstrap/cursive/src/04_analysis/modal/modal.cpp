...
// SPEC_DEF: LookupStateMethod(M, S, name) (CursiveSpecification.md, line 12290)
...
// SPEC_RULE: S ∈ States(M) (CursiveSpecification.md, line 12464)
...
// SPEC_DEF: States(M) (CursiveSpecification.md, line 12464)
