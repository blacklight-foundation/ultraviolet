 ...
 *
 * SPEC REFERENCE:
 *   - CursiveSpecification.md, Section 5.7 "Modal Widening" (line 12814)
 *   - CursiveSpecification.md, Section 5.7.1 "widen Expression" (lines 12820-12900)
 *   - CursiveSpecification.md, Section 7.2 "Modal Layout" (line 18619)
 *   - CursiveSpecification.md, Section 7.3 "Niche Optimization" (line 18635)
