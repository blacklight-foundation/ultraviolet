 ...
 *   - CursiveSpecification.md, Section 13.3.1 "Where Clauses" (lines 22470-22500)
 *   - CursiveSpecification.md, Section 13.3.2 "Predicate Syntax" (lines 22510-22520)
 *   - CursiveSpecification.md, Section 11 "Classes" (lines 22700-22900)
 *
...
bool CheckPredicateBound(
  ...
  // SPEC: CursiveSpecification.md PredOk definitions
