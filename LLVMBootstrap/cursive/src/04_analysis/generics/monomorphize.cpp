 ...
 *
 * SPEC REFERENCE:
 *   - CursiveSpecification.md, Section 13.1.4 "Monomorphization" (lines 22529-22565)
 *   - CursiveSpecification.md, Section 13.1.3 "Generic Instantiation"
 *   - CursiveSpecification.md, Section 13.4 "Class Constraints"
 *
 * This file implements the monomorphization system for Cursive generics:
...
static inline void SpecDefsMonomorphize() {
  SPEC_DEF("Instantiate", "C0X.13.1.4");
...
bool MonomorphizeContext::ProcessToFixedPoint() {
  ...
  // SPEC: CursiveSpecification.md Section 13.1.4 "Recursion Depth"
...
TypeRef InstantiateType(const TypeRef& type, const TypeSubst& subst) {
  ...
  // SPEC: CursiveSpecification.md Section 13.1.4
...
BoundCheckResult CheckBoundsSatisfied(
  ...
  // SPEC: CursiveSpecification.md Section 13.4.1 "Constraint Satisfaction"
...
InferResult InferTypeArguments(
  ...
  // SPEC: CursiveSpecification.md Section 13.1.3 "Type Inference"
  ...
  // expected_return is accepted for API stability; current Cursive0 inference
