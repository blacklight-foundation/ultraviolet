 ...
 *
 * SPEC REFERENCE:
 *   - CursiveSpecification.md, Section 1.1 "Conformance" (line 230)
 *   - CursiveSpecification.md, Section 8.5 "E-CNF Errors" (line 21534)
 *   - CursiveSpecification.md, Section 8.6 "W-CNF Warnings" (line 21545)
 *   - CursiveSpecification.md, Section 6.2 "Type Equivalence" (lines 15800-15900)
 *   - CursiveSpecification.md, Section 6.3 "Subtyping" (lines 15950-16100)
 *
 * MIGRATED FROM:
