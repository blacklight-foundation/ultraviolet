...
// =============================================================================
//
// SPEC REFERENCE: C0X Extension
//   Section C0X.5.Y: Variance Computation for Generic Type Parameters
...
//
// SOURCE FILE: cursive-bootstrap/src/03_analysis/types/variance.cpp
