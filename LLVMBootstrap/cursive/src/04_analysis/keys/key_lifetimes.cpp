...
//
// SPEC REFERENCE:
//   - CursiveSpecification.md, Section 17.2.2 "Key Release" (lines 24034-24050)
//   - CursiveSpecification.md, Section 17.1.6 "Wait Restrictions" (lines 23930-23936)
...
static inline void SpecDefsKeyLifetimes() {
  SPEC_DEF("KeyRelease", "C0X.17.2.2");
  SPEC_DEF("YieldNoKeys", "C0X.19.4.2");
  SPEC_DEF("WaitNoKeys", "C0X.17.1.6");
  SPEC_DEF("Staleness", "C0X.19.4.2");
}
