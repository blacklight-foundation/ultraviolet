#ifndef CURSIVE_RT_PLATFORM_LINUX_COMPAT_H
#define CURSIVE_RT_PLATFORM_LINUX_COMPAT_H

#ifndef CURSIVE_RT_PLATFORM_LINUX
#define CURSIVE_RT_PLATFORM_LINUX
#endif
...
typedef cursive_platform_handle_t HANDLE;
...
typedef cursive_platform_mutex_t CRITICAL_SECTION;
typedef cursive_platform_condition_t CONDITION_VARIABLE;
typedef cursive_platform_rwlock_t SRWLOCK;

typedef cursive_platform_once_t INIT_ONCE;
...
#endif  // CURSIVE_RT_PLATFORM_LINUX_COMPAT_H
