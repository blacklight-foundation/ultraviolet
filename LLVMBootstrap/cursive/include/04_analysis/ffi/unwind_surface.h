...
// =============================================================================
//
// SPEC REFERENCE: CursiveSpecification.md Section 2.7 (Unwind and FFI Surface)
//
// This module provides utilities for analyzing FFI boundaries and unwind
// behavior in Cursive programs. It is used at project level for:
...
// - "catch": Foreign unwinds converted to Cursive panics (imports),
//            Cursive panics caught and converted to error indicator (exports)
