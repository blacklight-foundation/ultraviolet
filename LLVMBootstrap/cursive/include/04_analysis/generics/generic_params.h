...
// Spec Section: CursiveSpecification.md Section 13 "Generics"
...
// Const generic parameter information (C0X extension)
...
// SPEC: CursiveSpecification.md Section 13.1 "Generic Parameters"
// Checks:
