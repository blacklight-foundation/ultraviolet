...
// CallingConvention = {Cursive0, C, CUnwind, System, Stdcall, Fastcall, Vectorcall}
...
// HostedEnvParamName = "__c0_host_env"
constexpr std::string_view kHostedEnvParamName = "__c0_host_env";

// AsyncOutParamName = "__c0_async_out"
constexpr std::string_view kAsyncOutParamName = "__c0_async_out";
