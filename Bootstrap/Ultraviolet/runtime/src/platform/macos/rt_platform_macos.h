#ifndef UV_RT_PLATFORM_MACOS_H
#define UV_RT_PLATFORM_MACOS_H
...
typedef struct UVRtHandleBase* uv_rt_backend_handle_t;
...
typedef pthread_key_t uv_rt_tls_key_t;
typedef uint64_t uv_rt_thread_id_t;
...
#define UV_RT_BACKEND_ONCE_INIT \
  { PTHREAD_MUTEX_INITIALIZER, PTHREAD_COND_INITIALIZER, 0, NULL }
#define UV_RT_BACKEND_RWLOCK_INIT PTHREAD_RWLOCK_INITIALIZER
#define UV_RT_BACKEND_TLS_KEY_INVALID ((uv_rt_tls_key_t)-1)
...
#define UV_RT_BACKEND_ERROR_DIR_NOT_EMPTY 145u
...
#define UV_PLATFORM_BACKEND_ERROR_DIR_NOT_EMPTY \
  UV_RT_BACKEND_ERROR_DIR_NOT_EMPTY
