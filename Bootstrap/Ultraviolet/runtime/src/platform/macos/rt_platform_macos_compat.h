#ifndef UV_RT_PLATFORM_MACOS_COMPAT_H
#define UV_RT_PLATFORM_MACOS_COMPAT_H

#ifndef UV_RT_PLATFORM_MACOS
#define UV_RT_PLATFORM_MACOS
#endif

typedef void (*uv_rt_panic_boundary_body_t)(void* context);

#include "rt_platform_macos.h"
...
#define FILE_ATTRIBUTE_REPARSE_POINT 0x40000000u
...
#define INIT_ONCE_STATIC_INIT UV_RT_BACKEND_ONCE_INIT
#define SRWLOCK_INIT UV_RT_BACKEND_RWLOCK_INIT
...
#endif  // UV_RT_PLATFORM_MACOS_COMPAT_H
