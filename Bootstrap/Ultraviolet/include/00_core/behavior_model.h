...
// =============================================================================
//
// Ultraviolet's behavior classification model. Ultraviolet does NOT have traditional
// "undefined behavior" (UB) as found in C/C++. Instead, Ultraviolet uses:
//
