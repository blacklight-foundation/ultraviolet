...
// Unwind and panic handling support for Ultraviolet codegen.
...
enum class UnwindMode {
  ...
  Catch,    // Convert between Ultraviolet panics and foreign unwinds
};
...
// For "catch" mode: converts Ultraviolet panic to error indicator
...
// Unwind(f_1::io, sigma) -> Unwind(io, sigma') on CleanupScope ok
// Unwind(f_1::io, sigma) -> Abort on CleanupScope panic
