...
//   - Capability flow tracking from entry context bundles to usage
//   - FFI capability isolation checking
//   - Capability passing validation
//
// AUTHORITY MODEL:
//   - All effects require explicit capability parameters
//   - Capabilities flow from context bundles through explicit parameters only
//   - Extern procedures CANNOT receive capability types (E-TYP-2623)
//   - main receives a Context bundle, which may expose only selected capabilities
//
// =============================================================================
...
struct CapabilityPath {
  ...
  /// The path components (e.g., ["ctx", "io"] for ctx.io)
