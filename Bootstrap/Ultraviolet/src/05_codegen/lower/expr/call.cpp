...
//
// DEPENDENCIES:
//   - ultraviolet/src/05_codegen/ir/ir_model.h (IRCall, IRValue)
//   - ultraviolet/src/05_codegen/abi/abi.h (NeedsPanicOut, kPanicOutName)
//   - ultraviolet/src/05_codegen/checks/checks.h (PanicCheck)
//
// =============================================================================
...
void RegisterProvisionalGenericProcSig(const GenericProcInfo& info,
  ...
  if (info.decl->return_type_opt) {
    if (const auto lowered_ret = ::ultraviolet::analysis::layout::LowerTypeForLayout(scope, info.decl->return_type_opt)) {
