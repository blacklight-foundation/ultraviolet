...
//
// DEPENDENCIES:
//   - ultraviolet/include/05_codegen/ir/ir_model.h (IRBindVar)
//   - ultraviolet/include/05_codegen/lower/lower_expr.h (LowerCtx, LowerResult)
//   - ultraviolet/include/05_codegen/lower/lower_pat.h (LowerBindPattern)
//   - ultraviolet/include/04_analysis/layout/layout.h (LowerTypeForLayout)
//
// =============================================================================
...
void RegisterSimpleClosureBindingDerived(const std::string& name,
  ...
  if (core::Conformance::Enabled()) {
    std::string payload =
        "source=LowerLetStmt.SimpleClosureBinding;operation=ClosureVal";
...
// ============================================================================
//
// Per the spec (Lines 16619-16622):
...
IRPtr LowerLetStmt(const ast::LetStmt& stmt, LowerCtx& ctx) {
  ...
  if (binding.pat) {
    ...
    checked_value.kind = IRValue::Kind::Local;
    checked_value.name = "anon_binding";
    if (var_type) {
      ctx.RegisterValueType(checked_value, var_type);
    }
  }
