...
//
// SOURCE FILE: ultraviolet-bootstrap/src/02_syntax/lexer_ident.cpp
//   Lines 1-75 (entire file)
//
// DEPENDENCIES:
//   - ultraviolet/include/02_source/lexer.h (IdentScanResult)
//   - ultraviolet/src/00_core/keywords.cpp (IsKeyword)
//   - ultraviolet/src/00_core/unicode.cpp (IsIdentStart, IsIdentContinue, IsNonCharacter)
...
//
// - Reserved namespace prefixes (ultraviolet., gen_) are NOT checked here
