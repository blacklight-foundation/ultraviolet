...
static inline void SpecDefsAttributes() {
  SPEC_DEF("Attribute", "UVX.6.A");
  SPEC_DEF("AttrTarget", "UVX.6.A");
  SPEC_DEF("AttrValidation", "UVX.6.A");
  SPEC_DEF("AttrRegistry", "UVX.6.A");
}
...
AttributeValidationResult ValidateAttributes(
  ...
  for (const auto& attr : attrs) {
    ...
    if (!registry.IsValidForTarget(attr.name, effective_target)) {
      result.ok = false;
      if (attr.name == ::ultraviolet::analysis::attrs::kDynamic &&
          effective_target == AttributeTarget::TypeAlias) {
        result.diag_id = "E-CON-0411";
      } else if (attr.name == ::ultraviolet::analysis::attrs::kDynamic &&
    ...
    if (attr.name == ::ultraviolet::analysis::attrs::kCold ||
        attr.name == ::ultraviolet::analysis::attrs::kReflect ||
        attr.name == ::ultraviolet::analysis::attrs::kDynamic ||
        attr.name == ::ultraviolet::analysis::attrs::kStaleOk ||
        attr.name == ::ultraviolet::analysis::attrs::kEmit ||
        attr.name == ::ultraviolet::analysis::attrs::kFiles ||
        attr.name == ::ultraviolet::analysis::attrs::kFfiPassByValue ||
        attr.name == ::ultraviolet::analysis::attrs::kStatic ||
        attr.name == ::ultraviolet::analysis::attrs::kRelaxed ||
        attr.name == ::ultraviolet::analysis::attrs::kAcquire ||
        attr.name == ::ultraviolet::analysis::attrs::kRelease ||
        attr.name == ::ultraviolet::analysis::attrs::kAcqRel ||
        attr.name == ::ultraviolet::analysis::attrs::kSeqCst) {
    ...
    if (attr.name == ::ultraviolet::analysis::attrs::kMangle) {
      if (attr.args.size() != 1) {
        result.ok = false;
    ...
    if (attr.name == ::ultraviolet::analysis::attrs::kInline) {
      if (attr.args.size() > 1) {
        result.ok = false;
        result.diag_id = "E-MOD-2450";
        result.span = attr.span;
    ...
    if (attr.name == ::ultraviolet::analysis::attrs::kDeprecated) {
      if (attr.args.size() > 1) {
        result.ok = false;
        result.diag_id = "E-MOD-2450";
        result.span = attr.span;
    ...
    if (attr.name == ::ultraviolet::analysis::attrs::kExport ||
        attr.name == ::ultraviolet::analysis::attrs::kHostExport) {
    ...
    if (attr.name == ::ultraviolet::analysis::attrs::kUnwind) {
