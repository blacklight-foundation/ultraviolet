...
//
// SOURCE FILE: ultraviolet-bootstrap/src/01_project/module_discovery.cpp
...
//    - PURPOSE: Check if directory contains .uv files
//    - SPEC RULE: Module-Dir: exists f in Files(d) : FileExt(f) = ".uv"
...
//    - PURPOSE: Get sorted list of .uv files in module directory
...
//
// Headers required:
//   - "uv/01_project/module_discovery.h" (types)
...
//   - "uv/00_core/path.h" (FileExt, Relative, PathComps)
//   - "uv/01_project/deterministic_order.h" (FileKey, KeyLess, Fold, DirSeqFrom)
//   - "uv/01_project/ident.h" (IsIdentifier, IsKeyword)
//   - <algorithm>
//   - <filesystem>
//   - <optional>
//   - <string>
...
CompilationUnitResult CompilationUnit(const std::filesystem::path& module_dir,
  ...
  if (const auto force = core::HostGetEnvUtf8("UV_TEST_COMPILATION_UNIT_FAIL");
