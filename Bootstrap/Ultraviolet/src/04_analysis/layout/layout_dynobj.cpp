...
//
// SOURCE FILE: ultraviolet-bootstrap/src/04_codegen/layout/layout_dynobj.cpp
//   - DynLayoutOf function (if exists)
//
// DEPENDENCIES:
//   - ultraviolet/include/04_analysis/layout/layout.h (Layout struct)
//   - ultraviolet/include/04_analysis/types/types.h (TypeDynamic)
//
// REFACTORING NOTES:
...
DynLayout DynLayoutOf(const ultraviolet::analysis::ScopeContext& ctx) {
  ...
  out.fields.push_back(
      ultraviolet::analysis::MakeTypeRawPtr(ultraviolet::analysis::RawPtrQual::Imm,
                                        ultraviolet::analysis::MakeTypePrim("()")));
  out.fields.push_back(
      ultraviolet::analysis::MakeTypeRawPtr(ultraviolet::analysis::RawPtrQual::Imm,
...
DynLayout DynLayoutOf() {
  ultraviolet::analysis::ScopeContext ctx;
  ctx.target_profile = ultraviolet::project::TargetProfile::X86_64SysV;
