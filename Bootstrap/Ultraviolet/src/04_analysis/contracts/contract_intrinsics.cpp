...
static inline void SpecDefsContractIntrinsics() {
  SPEC_DEF("ResultIntrinsic", "UVX.5.W");
  SPEC_DEF("EntryIntrinsic", "UVX.5.W");
  SPEC_DEF("EntryType", "UVX.5.W");
  SPEC_DEF("ForeignAssumes", "UVX.5.W");
  SPEC_DEF("ForeignEnsures", "UVX.5.W");
  SPEC_DEF("ForeignError", "UVX.5.W");
  SPEC_DEF("ForeignNull", "UVX.5.W");
}
