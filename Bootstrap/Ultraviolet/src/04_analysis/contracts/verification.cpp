...
static inline void SpecDefsVerification() {
  SPEC_DEF("StaticProof", "UVX.5.W");
  SPEC_DEF("Entailment", "UVX.5.W");
  SPEC_DEF("VerificationFact", "UVX.5.W");
  SPEC_DEF("Ent-True", "UVX.5.W");
  SPEC_DEF("Ent-Fact", "UVX.5.W");
  SPEC_DEF("Ent-And", "UVX.5.W");
  SPEC_DEF("Ent-Or", "UVX.5.W");
  SPEC_DEF("Ent-Linear", "UVX.5.W");
}
